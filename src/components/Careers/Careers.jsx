...
const jobOpenings = [
  ...
  },
  {
    ...
    description:
      "We are looking for a detail-oriented and motivated Accounts & Billing Executive to join our accounts team. The candidate will be responsible for handling billing operations, invoice processing, basic accounting activities, and maintaining financial records. ",

    responsibilities: [
      "Prepare and generate sales invoices and billing statements.",
      "Maintain billing records and ensure timely payments.",
      "Handle accounts receivable and payable entries.",
      "Reconcile invoices, payments, and account statements.",
      "Assist in GST/TDS data preparation and filing support.",
      "Maintain daily accounting records in ERP/Tally.",
      "Coordinate with internal departments and clients regarding billing queries.",
      "Prepare MIS reports and basic financial reports.",
      "Ensure accuracy and compliance in financial documentation.",
    ],
    ...
    skills: [
      ...
      "Preferred Qualifications: Knowledge of GST, TDS, and invoicing processes.",
      "Experience using ERP/Tally",
    ],
  },
];
